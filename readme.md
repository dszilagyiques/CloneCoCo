...
5. **Ensures the phase export type is the same**. Although the script is “phase-type aware,” you can copy 2D modules into other 2D-based phases (e.g., 2D iOS → 2D Web).  
